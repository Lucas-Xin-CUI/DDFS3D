...
write (41,'(A86)')'Stresses and displacments at the controid of each element in the respective local coordinate system:' 
write (41,'(A83)')' No.	    Szx            Szy          Szz            Ux            Uy           Uz '
do i=1,NELE
    write (41,'(I5,6es14.4)')i,str(i,1:3),dis(i,1:3)
end do
close(41)
end program FSM3D_qua_Part2