...
allocate(PPxx(NELE),PPxy(NELE),PPxz(NELE),PPyy(NELE),PPyz(NELE),PPzz(NELE),Ux(NELE),Uy(NELE),Uz(NELE),nor(NELE,6))
...
allocate(CFP(NOP,3),ORI(NOP,9))

do i=1,NOP
   read(23,*)AD,CFP(i,1:3),ORI(i,1:9)
...
!*****************************************************
! Dtermine the number of Gaussian points
!***************************************************** 
...
!************************************************************************        
		...
		call stress_regular_dd3d_qua_num_part3 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF1)  
...
do i=1,NOP
	...
	write (41,'(A12,ES15.6,A8,ES15.6,A8,ES15.6)')'         l1=',ORI(i,1),' m1=',ORI(i,2),' n1=',ORI(i,3)
	write (41,'(A12,ES15.6,A8,ES15.6,A8,ES15.6)')'         l2=',ORI(i,4),' m2=',ORI(i,5),' n2=',ORI(i,6)
	write (41,'(A12,ES15.6,A8,ES15.6,A8,ES15.6)')'         l3=',ORI(i,7),' m3=',ORI(i,8),' n3=',ORI(i,9)
