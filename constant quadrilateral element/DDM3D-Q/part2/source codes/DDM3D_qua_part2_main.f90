...
write (41,*)'*************************************************************************'
write (41,*)'************		    DDM3D_qua_part2		        **********'
write (41,*)'************	    developed by Wong and Cui (2021)            **********'
write (41,*)'************	       DDFS3D (version 1.0), 23-5-2021		**********'
write (41,*)'*************************************************************************'
...
write (41,'(A102)')'Stresses and displacements at the centroid of each element in the respective local coordinate system:' 
