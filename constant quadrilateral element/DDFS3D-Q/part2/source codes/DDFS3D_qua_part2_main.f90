...
allocate(NOD(NNOD,3),VOB(NELE,3),X(3*NELE),ELE(NELE,4),SOB(NELE,3),E_type(NELE),nor(NELE,3),str(NELE,3),dis(NELE,3))
...
!*****************************************************
        ...
        l(4)=sqrt((x1-x4)**2+(y1-y4)**2+(z2-z4)**2) 
