...
do 100 i=1,NOP     
    ...
    do 200 j=1,NELE            
        ...
        gpxx=(xx1+xx2+xx3+xx4)/3.
        gpyy=(yy1+yy2+yy3+yy4)/3.
        gpzz=(zz1+zz2+zz3+zz4)/3.
       
!*****************************************************
!Assign the number of Gaussian points
!***************************************************** 
