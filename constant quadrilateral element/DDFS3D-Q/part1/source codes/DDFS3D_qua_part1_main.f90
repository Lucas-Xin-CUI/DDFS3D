...
real*8::E,v,KN,KS,x1,y1,z1,x2,y2,z2,x3,y3,z3,x4,y4,z4,xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,gpx,gpy,gpz,COEFF1(3,3),COEFF2(3,3),IEvect(3,3),JEvect(3,3)
...
!$omp parallel do default(none) shared(COE,nor,AD1,progress,gx,gy,gz) shared(NELE,NOD,ELE,SOB,E_type,E,v,Pxx,Pyy,Pzz,Pxy,Pxz,Pyz) &
...
!************************************************************************        
        ...
        if (SOB(i,1)==0.and.SOB(i,2)==0.and.SOB(i,3)==0) then 
            if (i/=j)then
                if (E_type(j)==0)then
                   call stress_regular_fs3d_qua_num_part1 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF1)
                else 
				...
				if (E_type(j)==0)then
                    call stress_singular_fs3d_qua_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,E,v,M,IEvect,COEFF1)
				else 
            ...
            if (i/=j)then  
                if (E_type(j)==0)then
					call dis_regular_fs3d_qua_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF1) 
                else 
                ...
                if (E_type(j)==0)then
                    call dis_singular_fs3d_qua_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,E,v,M,IEvect,COEFF1)
                else 
            ...
            if (i/=j)then
                ...
                if (E_type(j)==0)then
                    call stress_singular_fs3d_qua_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,E,v,M,IEvect,COEFF1)
                    call    dis_singular_fs3d_qua_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,E,v,M,IEvect,COEFF2)
                else 
                    call stress_singular_dd3d_qua_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx4,yy4,zz4,E,v,M,IEvect,COEFF1)
