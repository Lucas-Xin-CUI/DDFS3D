...
subroutine dis_regular_fs3d_tri_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF)
implicit none 
...
!*****************************************************************
      U(1,1)= F5          + ( 3.0 - 4.0 * V ) * F1
      U(1,2)= F7
      U(1,3)= F3 * localZ
      U(2,1)= F7
      U(2,2)= F6          + ( 3.0 - 4.0 * V ) * F1
      U(2,3)= F4 * localZ
      U(3,1)= F3 * localZ
      U(3,2)= F4 * localZ
      U(3,3)= F2 * localZ + ( 3.0 - 4.0 * V ) * F1
...
end subroutine dis_regular_fs3d_tri_num
     

subroutine dis_singular_fs3d_tri_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,EE,v,M,IEvect,COEFF)
...
real*8::F1,F2,F3,F4,F5,F6,F7,U(3,3),JI(3,3)
integer::M,I,J
...
end subroutine dis_singular_fs3d_tri_num 


subroutine stress_regular_fs3d_tri_num_part1 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF)
implicit none 
...
end subroutine stress_regular_fs3d_tri_num_part1


subroutine stress_regular_fs3d_tri_num_part3 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF)
implicit none 
...
end subroutine stress_regular_fs3d_tri_num_part3


subroutine stress_singular_fs3d_tri_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,EE,v,M,IEvect,COEFF)
implicit none 
...
end subroutine stress_singular_fs3d_tri_num
