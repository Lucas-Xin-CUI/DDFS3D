...
!************************************************************************        
        ...
        if (i==j)then
            if (E_Type(j)==2)then
                COEFF1(1,1)=COEFF1(1,1)+KS
                COEFF1(2,2)=COEFF1(2,2)+KS
                COEFF1(3,3)=COEFF1(3,3)+KN
            end if 
        end if 
