...
integer::self_T,M,NELE,NNOD,AD,TY,i,j,k,ii,jj,RES(6),NOP
...
allocate(NOD(NNOD,3),VOB(NELE,3),X(3*NELE),ELE(NELE,3),SOB(NELE,3),E_Type(nele))
...
allocate(CFP(NOP,3),LCS(NOP,9))
allocate(PPxx(NOP),PPxy(NOP),PPxz(NOP),PPyy(NOP),PPyz(NOP),PPzz(NOP),Ux(NOP),Uy(NOP),Uz(NOP),nor(NOP,6))
do i=1,NOP
...
!***************************************************** 
        ...
        l(3)=sqrt((xx3-xx1)**2+(yy3-yy1)**2+(zz3-zz1)**2) 
...
!************************************************************************        
		...
		if (E_Type(j)==0)then
			call stress_regular_fs3d_tri_num_part3 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF1)  
			call          dis_regular_fs3d_tri_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF2)  
		else 
			call stress_regular_dd3d_tri_num_part3 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF1)  
...
write (41,*)'Stresses and displacments at specific points:' 
do i=1,NOP
