...
subroutine dis_regular_dd3d_tri_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF)
implicit none 

real*8::E,v,cond,l1,l2,l3,p,area,x1,y1,z1,x2,y2,z2,x3,y3,z3,xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz
...
integer::i,j,k,M,JJ
real*8,allocatable::pw1(:,:),pw2(:,:)

    cond=1./8./3.141592653/(1-v)
    
    l1=sqrt((xx2-xx1)**2+(yy2-yy1)**2+(zz2-zz1)**2)
    l2=sqrt((xx3-xx1)**2+(yy3-yy1)**2+(zz3-zz1)**2)
    l3=sqrt((xx3-xx2)**2+(yy3-yy2)**2+(zz3-zz2)**2) 
    p=(l1+l2+l3)/2.
...
!**************************************************************
!Calculate partial derivertives
!**************************************************************    
allocate (pw1(M,2))
...
end subroutine dis_regular_dd3d_tri_num   
     

subroutine dis_singular_dd3d_tri_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,E,v,M,IEvect,COEFF)

real*8::E,v,G,cons,l1,l2,l3,p,area,x(4),y(4),z(4),xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx(3),yy(3),zz(3)
...
do 100 i=1,3
 ...
 !**************************************************************************************
        A=A+pw1(j,2)*area*xm*log(r)/r**3
        B=B+pw1(j,2)*area*ym*log(r)/r**3
...
end subroutine dis_singular_dd3d_tri_num


subroutine stress_regular_dd3d_tri_num_part1 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF)
implicit none 

real*8::E,v,G,cons,l1,l2,l3,p,area,x1,y1,z1,x2,y2,z2,x3,y3,z3,xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz
real*8::VecIJ_x,VecIJ_y,VecIJ_z,localx,localy,localz,IEvect(3,3),JEvect(3,3),COEFF(3,3)
...
!*****************************************************************************
! for stresses, partial derivatives of first order are uncessary.
!******************************************************************************
!!Calculate Ix   
!   Ix=0.
!    do i=1,M
...
!************************************************************
! cauculate influence coefficients 
!************************************************************
...
end subroutine stress_regular_dd3d_tri_num_part1


subroutine stress_regular_dd3d_tri_num_part3 (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,gpx,gpy,gpz,E,v,M,IEvect,JEvect,COEFF)
implicit none 
...
end subroutine stress_regular_dd3d_tri_num_part3


subroutine stress_singular_dd3d_tri_num (xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,EE,v,M,IEvect,COEFF)
implicit none 

real*8::EE,v,GG,cons,l1,l2,l3,p,area,x(4),y(4),z(4),xx1,yy1,zz1,xx2,yy2,zz2,xx3,yy3,zz3,xx(3),yy(3),zz(3)
...
do 100 ii=1,3
 ...
 !**************************************************************************************
        A=A-pw1(jj,2)*area/r**3
        B=B-pw1(jj,2)*area*xm**2/r**5
        C=C-pw1(jj,2)*area*xm*ym/r**5
        !D=D-pw1(jj,2)*0.5*area*xm**3/r**6
        !E=E-pw1(jj,2)*0.5*area*xm/r**4
        !F=F-pw1(jj,2)*0.5*area*xm**2*ym/r**6
        G=G-pw1(jj,2)*area*ym**2/r**5
        !H=H-pw1(jj,2)*0.5*area*ym**3/r**6
        !I=I-pw1(jj,2)*0.5*area*ym/r**4
        !J=J-pw1(jj,2)*0.5*area*ym**2*xm/r**6
...
end subroutine stress_singular_dd3d_tri_num
