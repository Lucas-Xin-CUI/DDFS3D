...
integer:: M,NELE,NNOD,AD,AD1,TY,i,j,k,ii,jj,res(6),iter
integer::Self_T
...
write (*,*)'*************************************************************************'
write (*,*)'************		    DDM3D_tri_part1		        **********'
write (*,*)'************	        Algorithm developed by                  **********'
write (*,*)'************	 Kuriyama et al.(1993) and Tang et al. (2019)   **********'
write (*,*)'************	   Codes developed by Wong and Cui (2021)	**********'
...
!*****************************************************
! Deternimne the number of Gaussian points
!*****************************************************
...
write (41,*)'*************************************************************************'
write (41,*)'************		    DDM3D_tri_part1		        **********'
write (41,*)'************	        Algorithm developed by                  **********'
write (41,*)'************	 Kuriyama et al.(1993) and Tang et al. (2019)   **********'
write (41,*)'************	   Codes developed by Wong and Cui (2021)	**********'
